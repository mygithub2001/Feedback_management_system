...
<div id="table"> 
    <div class="tr">
     ...
     <div class="td">
            ...
            <?php
			$x=mysqli_query($al,"select distinct subject,subject_code from faculty WHERE faculty_id='".$_SESSION['faculty_id']."'");
			while($y=mysqli_fetch_array($x))
			{
			 ?>
             <option value="<?php echo $y['subject'];?>"><?php echo $y['subject'];?></option>
             <option value="<?php echo $y['subject_code'];?>"><?php echo $y['subject_code'];?></option>
